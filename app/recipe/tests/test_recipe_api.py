...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipes is limited to authnticated user."""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ingredient = Ingredient.objects.create(user=self.user, name='Leamon')
        payload = {
            'title': 'Vietname soup',
            'time_minutes': 25,
            'price': '2.25',
            'ingredients': [{'name': 'Leamon'},{'name':'Fish Sauce'}],
